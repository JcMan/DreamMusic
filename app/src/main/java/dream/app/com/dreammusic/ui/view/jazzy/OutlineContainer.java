package dream.app.com.dreammusic.ui.view.jazzy;
...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(JazzyUtil.dpToPx(getResources(), 2));
		mOutlinePaint.setColor(Color.parseColor("#FF33E5B5"));
		mOutlinePaint.setStyle(Style.STROKE);
		int padding = JazzyUtil.dpToPx(getResources(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = JazzyUtil.dpToPx(getResources(), 5);
