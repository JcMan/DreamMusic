...
//		setBackgroundColor(Color.TRANSPARENT); 
        ...
        // 获取自定义属性 指示符的颜色
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ViewIndicator, 0, 0);
        mColor = ta.getColor(R.styleable.ViewIndicator_jcolor, 0XFF00FF00);
        mHeight = (int) ta.getDimension(R.styleable.ViewIndicator_jheight, 2);
        ta.recycle();
