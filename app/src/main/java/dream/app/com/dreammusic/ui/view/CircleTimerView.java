...
public class CircleTimerView extends View
{
    ...
    // Default color0xFFE9E2D9  0xFFE9E2D9
    private static final int DEFAULT_CIRCLE_COLOR = Color.parseColor("#515151");
    private static final int DEFAULT_CIRCLE_BUTTON_COLOR = 0xFFFFFFFF;
    private static final int DEFAULT_LINE_COLOR = Color.parseColor("#838383");
    private static final int DEFAULT_HIGHLIGHT_LINE_COLOR = Color.parseColor("#2E94FD");
    ...
    private static final int DEFAULT_TIMER_NUMBER_COLOR = Color.parseColor("#2E94FD");
    private static final int DEFAULT_TIMER_COLON_COLOR = DEFAULT_TIMER_NUMBER_COLOR;
...
//        canvas.drawColor(Color.RED);
        ...
        canvas.drawText("45", getMeasuredWidth()/2 - radius + circleStorkeWidth / 2 + gapBetweenCircleAndLine + longerLineLength + textLength / 2 + gapBetweenNumberAndLine, cy + getFontHeight(numberPaint) / 2, numberPaint);
        // Circle button
        canvas.save();
    ...
    public void setCurrentRadian(int totalSecond){
        currentRadian = (float)(totalSecond*((2*Math.PI)/3600));
        currentTime = (int) (60 / (2 * Math.PI) * currentRadian * 60);
    }
