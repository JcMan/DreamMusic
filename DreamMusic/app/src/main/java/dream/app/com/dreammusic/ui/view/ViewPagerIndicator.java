...
//	private static final int COLOR_TEXT_NORMAL = 0x77FFFFFF;
    private static final int COLOR_TEXT_NORMAL = Color.rgb(180, 184, 187);

    /** 标题选中时的颜色*/
//	private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFFFFFFFF;
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = Color.rgb(45,147,252);
...
//		mPaint.setColor(Color.parseColor("#ffffffff"));
        mPaint.setColor(Color.parseColor("#18B4ED"));
